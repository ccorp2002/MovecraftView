<?php
  class MovecraftView_formatting{
      ...
      foreach ($properties as $k => $key){
        ...
        if (!$exists){
          ...
          foreach ($types as $a => $craft){
            $to_combo = false;
            if ($array_to_combo){
              if ($key == MV_KEY_PHASE_BLOCKS || $key == MV_KEY_HARVEST_BLOCKS || $key == MV_KEY_MOVE_BLOCKS || $key == MV_KEY_FLY_BLOCKS || $key == MV_KEY_ALLOWED_BLOCKS || $key == MV_KEY_FORBIDDEN_BLOCKS){
                $to_combo = true;
              }
            }
      ...
      foreach ($types as $a => $craft){
        ...
        foreach ($properties as $k => $key){
          ...
          if (!$exists){
            $to_combo = false;
            if ($array_to_combo){
              if ($key == MV_KEY_PHASE_BLOCKS || $key == MV_KEY_HARVEST_BLOCKS || $key == MV_KEY_FLY_BLOCKS || $key == MV_KEY_ALLOWED_BLOCKS || $key == MV_KEY_FORBIDDEN_BLOCKS){
                $to_combo = true;
              }
            }
    ...
    function printSingleTableBody($craft_name){
        ...
        echo "</tr><tr>";
          echo "<td align='center' title='".MV_TITLE_MIN_SIZE."'>".$craft->getStringByKey(MV_KEY_MIN_SIZE)."</td>";
          echo "<td align='center' title='".MV_TITLE_MAX_SIZE."'>".$craft->getStringByKey(MV_KEY_MAX_SIZE)."</td>";
          echo "<td align='center' title='".MV_TITLE_SPEED."'>".$craft->getStringByKey(MV_KEY_SPEED)."</td>";
          echo "<td align='center' title='".MV_TITLE_CRUISE_SPEED."'>".($craft->getStringByKey(MV_KEY_CRUISE_SKIP_BLOCKS)*$craft->getStringByKey(MV_KEY_SPEED))."</td>";
          echo "<td align='center' title='".MV_TITLE_CRUISE_SKIP_BLOCKS."'>".$craft->getStringByKey(MV_KEY_CRUISE_SKIP_BLOCKS)."</td>";
          echo "<td align='center' title='".MV_TITLE_HOVER_LIMIT."'>".$craft->getStringByKey(MV_KEY_HOVER_LIMIT)."</td>";
          echo "<td align='center' title='".MV_TITLE_SINK_PERCENT."'>".$craft->getStringByKey(MV_KEY_SINK_PERCENT)."</td>";
          echo "<td align='center' title='".MV_TITLE_COLLISION_EXPLOSION."'>".$craft->getStringByKey(MV_KEY_COLLISION_EXPLOSION)."</td>";
          echo "<td align='center' title='".MV_TITLE_MIN_HEIGHT_LIMIT."'>".$craft->getStringByKey(MV_KEY_MIN_HEIGHT_LIMIT)."</td>";
          echo "<td align='center' title='".MV_TITLE_MAX_HEIGHT_LIMIT."'>".$craft->getStringByKey(MV_KEY_MAX_HEIGHT_LIMIT)."</td>";
        echo "</tr><tr>";  
          echo "<td colspan='10'><br/></td>";
        echo "</tr><tr>";
          ...
          //echo "<th></th>";
        echo "</tr><tr>";
          echo "<td align='center' title='".MV_TITLE_FUEL_BURN_RATE."'>".$craft->getStringByKey(MV_KEY_FUEL_BURN_RATE)."</td>";
        ...
        echo "</tr><tr>";
          ...
          echo "<td colspan='9' title='".MV_TITLE_FLY_BLOCKS."'>".strtolower($craft->getStringByKey(MV_KEY_FLY_BLOCKS))."</td>";
        echo "</tr><tr>";
          echo "<th valign='top' align='right' title='".MV_TITLE_MOVE_BLOCKS."'>".MV_LABEL_MOVE_BLOCKS."</th>";
          echo "<td colspan='9' title='".MV_TITLE_MOVE_BLOCKS."'>".strtolower($craft->getStringByKey(MV_KEY_MOVE_BLOCKS))."</td>";
        echo "</tr><tr>";
          echo "<th valign='top' align='right' title='".MV_TITLE_ALLOWED_BLOCKS."'>".MV_LABEL_ALLOWED_BLOCKS."</th>";
          echo "<td colspan='9' title='".MV_TITLE_ALLOWED_BLOCKS."'>".strtolower($craft->getStringByKey(MV_KEY_ALLOWED_BLOCKS))."</td>";
        echo "</tr><tr>";
          echo "<th valign='top' align='right' title='".MV_TITLE_FORBIDDEN_BLOCKS."'>".MV_LABEL_FORBIDDEN_BLOCKS."</th>";
          echo "<td colspan='9' title='".MV_TITLE_FORBIDDEN_BLOCKS."'>".strtolower($craft->getStringByKey(MV_KEY_FORBIDDEN_BLOCKS))."</td>";
        echo "</tr><tr>";        
          echo "<th valign='top' align='right' title='".MV_TITLE_HARVEST_BLOCKS."'>".MV_LABEL_HARVEST_BLOCKS."</th>";
          echo "<td colspan='9' title='".MV_TITLE_HARVEST_BLOCKS."'>".strtolower($craft->getStringByKey(MV_KEY_HARVEST_BLOCKS))."</td>";
          echo "</tr><tr>";        
            echo "<th valign='top' align='right' title='".MV_TITLE_PHASE_BLOCKS."'>".MV_LABEL_PHASE_BLOCKS."</th>";
            echo "<td colspan='9' title='".MV_TITLE_PHASE_BLOCKS."'>".strtolower($craft->getStringByKey(MV_KEY_PHASE_BLOCKS))."</td>";
        echo "</tr>";
